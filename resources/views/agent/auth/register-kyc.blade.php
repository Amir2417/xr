        ...
        <div class="kyc-form">
            ...
            <form class="account-form" action="{{ setRoute('agent.register.submit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 form-group">
                        <div class="custom-check-group">
                            <div class="custom-check-group mb-0">
                                ...
                                @endphp
                                <label for="level-1" class="mb-0">{{ __("I have agreed with") }} <a href="{{ setRoute('link',$data->slug) }}">{{__("Terms Of Use & Privacy Policy")}}</a></label>
                            </div>
                ...
                <div class="form-group text-center pt-5">
                    <button type="submit" class="btn--base btn w-100">{{ __("Continue") }}</button>
                </div>
