        ...
        <div class="support-card-wrapper">
            <div class="card-header">
                <div class="card-header-user-area">
                    <img class="avatar" src="{{ auth()->user()->agentImage ?? "" }}" alt="client">
                    <div class="card-header-user-content">
                        <h6 class="title">{{ $support_ticket->agent->fullname ?? "" }}</h6>
            ...
            <div class="support-chat-area">
                ...
                @include('agent.components.support-ticket.conversation-message-input',['support_ticket' => $support_ticket])   
                </div>
            </div>
            @include('agent.components.support-ticket.details',['support_ticket' => $support_ticket])
    </div>
</div>
@endsection
...
@include('admin.components.support-ticket.conversation.connection-agent',[
    ...
    'route'          => setRoute('agent.support.ticket.message.send'),
])