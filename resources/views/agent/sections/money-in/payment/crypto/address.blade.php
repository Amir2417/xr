    ...
    <div class="row mb-20">
        <div class="send-add-form row g-4">
            <div class="col-xxl-8 col-lg-12 col-12 form-area mb-40">
                ...
                @if ($transaction->status == global_const()::REMITTANCE_STATUS_CONFIRM_PAYMENT)
                    <form class="row g-4 submit-form" method="POST" action="{{ setRoute('agent.moneyin.payment.crypto.confirm',$transaction->trx_id) }}">
                        @csrf
