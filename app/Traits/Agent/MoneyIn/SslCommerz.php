<?php
namespace App\Traits\Agent\MoneyIn;
...
trait SslCommerz {
    ...
    public function sslcommerzCallbackResponse($reference,$callback_data, $output = null) {
        ...
        if(isset($output['transaction']) && $output['transaction'] != null && $output['transaction']->status != GlobalConst::REMITTANCE_STATUS_CONFIRM_PAYMENT) { // if transaction already created & status is not success
