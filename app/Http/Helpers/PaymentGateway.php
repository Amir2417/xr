...
class PaymentGateway {
    ...
    public function chargeCalculate($currency,$receiver_currency = null) {
        ...
        if($receiver_currency) {
            ...
            $will_get = $receive_money;
            $total_Amount = ($convert_amount * $sender_currency_rate) ;
            $data = [
    ...
    public function responseReceive($type = null) {
        ...
        $total_charge = $tempData['data']->amount->total_charge ?? 0;
        $convert_amount = $tempData['data']->amount->convert_amount ?? 0;
        $receive_money = $tempData['data']->amount->will_get ?? 0;
