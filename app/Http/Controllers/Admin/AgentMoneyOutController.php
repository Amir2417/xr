...
use App\Notifications\Admin\AgentMoneyOutNotification;
...
class AgentMoneyOutController extends Controller
{
    ...
    public function index(){
        $page_title           = "All Logs";
        $transactions         = Transaction::whereNot('agent_id',null)->doesntHave('coupon_transaction')->where('type',PaymentGatewayConst::MONEYOUT)->orderBy('id','desc')->paginate(10);
        
        return view('admin.sections.agent-logs.money-out.all-logs',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function details(Request $request, $trx_id){
        ...
        return view('admin.sections.agent-logs.money-out.details',compact(
            'page_title',
            'transaction',
        ));
    }
    ...
    public function statusUpdate(Request $request,$trx_id){
        ...
        try{
            ...
            if($basic_settings->agent_email_notification == true){
                Notification::route("mail",$transaction->agent->email)->notify(new AgentMoneyOutNotification($form_data));
            }
    ...
    public function reviewPayment(){
        ...
        $transactions  = Transaction::whereNot('agent_id',null)->doesntHave('coupon_transaction')->where('type',PaymentGatewayConst::MONEYOUT)
                            ->where('status',global_const()::REMITTANCE_STATUS_REVIEW_PAYMENT)
                            ->orderBy('id','desc')->paginate(10);

        return view('admin.sections.agent-logs.money-out.review-payment',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function pending(){
        ...
        return view('admin.sections.agent-logs.money-out.pending',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function confirmPayment(){
        ...
        return view('admin.sections.agent-logs.money-out.confirm-payment',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function hold(){
        ...
        return view('admin.sections.agent-logs.money-out.hold',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function settled(){
        ...
        return view('admin.sections.agent-logs.money-out.settled',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function complete(){
        ...
        return view('admin.sections.agent-logs.money-out.complete',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function canceled(){
        ...
        return view('admin.sections.agent-logs.money-out.cancel',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function failed(){
        ...
        return view('admin.sections.agent-logs.money-out.failed',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function refunded(){
        ...
        return view('admin.sections.agent-logs.money-out.refunded',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function delayed(){
        ...
        return view('admin.sections.agent-logs.money-out.delayed',compact(
            'page_title',
            'transactions',
        ));
    }
    ...
    public function search(Request $request) {
        ...
        return view('admin.components.data-table.agent.money-out-table',compact('transactions'));
